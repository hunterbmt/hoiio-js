...
var hoiio_number = {
	...
	supportedCountries:function(callbackFunction){
		var params ={app_id:hoiio_number.app_id,access_token:hoiio_number.access_token};
	...
	availableNumbers:function(country,state,callbackFunction,options){
		var params ={app_id:hoiio_number.app_id,access_token:hoiio_number.access_token,country:country,state:state};
	...
	rates:function(country,callbackFunction){
		var params ={app_id:hoiio_number.app_id,access_token:hoiio_number.access_token,country:country};
	...
	subscription:function(number,duration,callbackFunction){
		var params ={app_id:hoiio_number.app_id,access_token:hoiio_number.access_token,number:number,duration:duration};
	...
	configForwarding:function(number,callbackFunction,options){
		var params ={app_id:hoiio_number.app_id,access_token:hoiio_number.access_token,number:number};
		if(options !=undefined){
