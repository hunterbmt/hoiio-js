...
var hoiio_sms ={
	...
	send :function(dest,msg,callbackFunction,options){
		var params ={app_id:hoiio_sms.app_id,access_token:hoiio_sms.access_token,dest:dest,msg:msg};
	...
	history :function(callbackFunction,options){
		var params ={app_id:hoiio_sms.app_id,access_token:hoiio_sms.access_token};
		if(options !=undefined){
	...
	rate :function(dest,incoming,msg,callbackFunction){
		var params ={app_id:hoiio_sms.app_id,access_token:hoiio_sms.access_token,dest:dest,incoming:incoming,msg:msg};
	...
	queryStatus :function(txn_ref,callbackFunction){
		var params ={app_id:hoiio_sms.app_id,access_token:hoiio_sms.access_token,txn_ref:txn_ref};
